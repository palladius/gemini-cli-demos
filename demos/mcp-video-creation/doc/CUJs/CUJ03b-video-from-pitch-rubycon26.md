...
* Pitch: Join us for an event, some tickets still available!
* CTA: "Buy your exclusive ticket at https://rubycon.it/" (but make it short in video!)
...
* Imagery:
  ...
  * Bagno 46, Rimini (Toga party on the beach).

##  Elements which might be included

* Ruby Logo.
  * Note: using the wording "red diamonds" (diamond pentagonal shape) might result in more realistic images than real rubies (round). Rubies are "brilliant cut"
...
* [Matz](https://en.wikipedia.org/wiki/Yukihiro_Matsumoto) (Yukihiro Matsumoto, Japanese computer scientist, born 1965) is the creator of the programming language Ruby. Would be nice to add some trolling like a Japanese 60-old smiling scientist with glasses wearing a japanese clothing or a Toga. Note that using the exact name might result in Image model failing to visualize. Try anonmizing and maybe using a cartoon instead.
